...
const backgrounds = [
  ...
  { html: 'bg3-autism-man-v2.html', png: 'MAG-Zoom-BG-3-Autism-Man-v2.png' },
  { html: 'bg4-everyday-purple.html', png: 'MAG-Zoom-BG-4-Everyday-Purple.png' },
];
